...
def check_cuda() -> None:
    """Print whether CUDA is available and the device name if possible."""
...
def frame_to_tensor(image_path: str) -> torch.Tensor:
    """Load with OpenCV, convert to PIL, then to a normalized tensor."""
